//
//  UIApplication+Hook2.m
//  YuemengSdkDemo_GDT
//
//  Created by wangdh on 2019/12/26.
//  Copyright © 2019 wangdh. All rights reserved.
//

#import "UIApplication+Hook2.h"

#import <objc/runtime.h>


@implementation UIApplication (Hook2)

+ (void)load
{
//    SEL origSel = @selector(setDelegate:);
//    SEL swizSel = @selector(setDelegateEx2:);
...
-(void) setDelegateEx2:(id<UIApplicationDelegate>) delegate{
    
    [self setDelegateEx2:delegate];
    
    SEL origSel = @selector(application:didFinishLaunchingWithOptions:);
    SEL swizSel = @selector(application:didFinishLaunchingWithOptionsEx2:);
